<h2><a href="https://leetcode.com/problems/delete-nodes-and-return-forest/solution/">1110. Delete Nodes And Return Forest</a></h2><h3>Medium</h3><hr><div><p>Given the <code>root</code> of a binary tree, each node in the tree has a distinct value.</p>
